...
void test()
{
    ...
    while (1)
    {
        ...
        //if(Recv()==1)
                {
                    //SendRadioAccelerometerSensor();
                    //SendRadioCompassSensor();
                    //SendRadioLightSensor();
                    //SendRadioPitchAndRollSensor();
                    //SendRadioTemperatureSensor();
                    //SendRadioAllSensors();
                    
                    //SendRadioPicture();
                    
                    //SendSerialAccelerometerSensor();
                    //SendSerialCompassSensor();
                    //SendSerialLightSensor();
                    //SendSerialPitchAndRollSensor();
                    //SendSerialTemperatureSensor();
                    SendSerialAllSensors();
